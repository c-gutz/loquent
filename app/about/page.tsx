    ...
    <main className="px-5 pt-12 pb-20 sm:px-8 sm:pt-16">
      <div className="mx-auto w-full max-w-xl">
        <header>
          ...
          <h1 className="mt-3 font-mono text-3xl font-semibold leading-tight tracking-tight sm:text-4xl">
            Project Overview
          </h1>
        ...
        <article
          className="mt-10 border-t border-edge pt-10 sm:mt-12 sm:pt-12
                  ...
                  sm:[&>p]:text-base
                  [&>*:first-child]:mt-0
                  [&_a]:underline [&_a]:decoration-edge-strong [&_a]:underline-offset-4
                  [&_a:hover]:decoration-chalk
                  ...
                  [&>ul>li]:before:h-1 [&>ul>li]:before:w-1 [&>ul>li]:before:bg-marker [&>ul>li]:before:content-['']"
        >
          <p>
